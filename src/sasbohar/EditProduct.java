...
public class EditProduct extends javax.swing.JFrame {
    ...
    public EditProduct(String pid,String pname,String brand,String colour,String image,String price) {
        initComponents();
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        if (validate) {
            ...
            try {
                ...
                stmt.execute("UPDATE products SET p_id='" + pid + "',p_name='" + pname + "',brand='" + brand + "',colour='" + colour + "',image='" + image + "',price='" + price + "' WHERE p_id='" + pid + "';");
